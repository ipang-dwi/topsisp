	...
	<div class="container">
      ...
      <nav class="navbar navbar-default">
		...
		<ol class="breadcrumb">
		  <li><a href="index.php">Home</a></li>
		  <li><a href="alternatif.php">Penilaian</a></li>
		  <li class="active">Tambah Penilaian</li>
		</ol>
      <!-- Main component for a primary marketing message or call to action -->
      <div class="panel panel-primary">
		  <!-- Default panel contents -->
		  <div class="panel-heading">Tambah Penilaian</div>
							...
							<form role="form" method="post" action="add.php">
                                    <div class="box-body">
										...
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="alternatif" id="alternatif" placeholder="Nama Karyawan" required />
                                        </div>
