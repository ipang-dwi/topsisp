        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li><a href="alternatif.php">Penilian</a></li>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="kepentingan" id="kepentingan">
												<option value='1' <?php if($row["kepentingan"]==1) echo "selected"?>>Sangat Buruk</option>
												<option value='2' <?php if($row["kepentingan"]==2) echo "selected"?>>Buruk</option>
												<option value='3' <?php if($row["kepentingan"]==3) echo "selected"?>>Cukup</option>
												<option value='4' <?php if($row["kepentingan"]==4) echo "selected"?>>Baik</option>
												<option value='5' <?php if($row["kepentingan"]==5) echo "selected"?>>Sangat Baik</option>
										    </select>
										</div>
										<div class="form-group">
